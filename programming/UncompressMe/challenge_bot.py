...
time.sleep(5) # seems necessary for the server to be ready
send_command(s, "PRIVMSG " + bot_name_rootme + " :!ep4\r\n")
        ...
        if get_pwd == False:
            ...
            if line.find("PRIVMSG "+bot_name) >-1 :
                ...
                if user_name == bot_name_rootme:
                    ...
                    decodedString = zlib.decompress(decodedString).decode()
                    print("decodedString = "+decodedString)

                    command = "PRIVMSG " + bot_name_rootme + " :!ep4 -rep " + decodedString + "\r\n"
